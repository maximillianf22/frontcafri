<header>
  <div class="fixed-top bg-white box-shadow">
    ...
    <div class="row head-app-mercapanda ">
      ...
      <div class="col col-lg-4 col-md-4 brd_ col-sm-4 menu-right ">
          <div class="pad-all brd_" style="width:200px">Buscador</div>
          <div class="brd_" style="width:50%"  style="position:absolute !important; margin-left:46px">
          @if(Auth::check())
            <span class="userauth">{{Auth::user()->nameUser}} {{Auth::user()->lastnameUser}}</span>
          @else
