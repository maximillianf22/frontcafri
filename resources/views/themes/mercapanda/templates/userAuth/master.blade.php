...
<body class="hold-transition skin-blue-light sidebar-mini">
  ...
  <div class="wrapper">
    @include('themes.'.$Config_->name_theme.'.templates.userAuth.header')
    @include('themes.'.$Config_->name_theme.'.layouts.sidebar')
    @yield('content-theme')
    @include('themes.'.$Config_->name_theme.'.layouts.footer')
