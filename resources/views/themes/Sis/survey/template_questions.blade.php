@if(sizeof($TemplateQuestions_))
     ...
     <div id="Questions-{{$Questions_->id}}" data-template="{{$Questions_->idTemplate}}" data-question="{{$Questions_->id}}" class="item-survey brd_"> 
          <div class="items-options float-right">
               <span id="edit-questions" class="icn-options-items"><i class="lni-pencil-alt"></i></span>
               <span id="trash-questions" onclick="TrasQuestionSurvey_({{$Questions_->id}})" class="icn-options-items"><i class="lni-trash"></i></span>
          </div>
