                                                  ...
                                                  <div class="form-group pad-all">
                                                       ...
                                                       <select id="nCategory" name="Category_Product" class="form-control jj-select select2 jj-item" required>
                                                            ...
                                                            <optgroup label="{{$Category_->nameCategorie}}" style="font-weight: bold; font-size:8pt">
                                                                 ...
                                                                 @else
                                                                 <option value="{{$Category_->id_categorie}}" style="font-style: italic;" @if($Category_->id_categorie == $Products->idCategorie) selected @endif >
                                        ...
                                        <div class="row ">
                                             <div class="col-lg-12">
                                                  <div class="form-group pad-all">
                                                       ...
                                                       <input id="titleVariation" type="text" name="titleVariation" value="{{$Products->titleVariation}}" class="input-text" placeholder="nombre/titulo para la variación" required>
                                                  </div>
                                             </div>
                                        </div>
                                             ...
                                             <div class="col-lg-3" style="border-bottom:1px solid #DFE5EB">
                                                  <div class="form-group pad-all">
                                                       ...
                                                       <div class="input-group input-prefix number">
                                                            <label> </label>
                                                            <input id="nAmount_per_sale" type="number" min="1" name="Price" value="{{$Product_main->amount_per_sale}}" class="form-control jj-number " style="border:none !important; margin-top:-5px !important" placeholder="Precio" required>
                                                       </div>
                                                  </div>
                                             </div>
                                             <div class="col-lg-3" style="border-bottom:1px solid #DFE5EB">
                                                  ...
                                                  <div class="row">
                                                       ...
                                                       <div class="col-lg-6 col-md-12">
                                                            <div class="form-group pad-all">
                                                                 ...
                                                                 <div class="input-group input-prefix number">
                                                                      <label> $ </label>
                                                                      <input id="nPriceProduct" type="number" min="1" name="Price" value="{{$Product_main->priceProduct}}" class="form-control jj-number " style="border:none !important; margin-top:-5px !important" placeholder="Precio" required>
                                                                 </div>
                                                            </div>
                                                       </div>
                                                       <div class="col-lg-6 col-md-12">
                                                            <div class="form-group pad-all">
                                                                 ...
                                                                 <div class="input-group input-prefix number">
                                                                      <label> $ </label>
                                                                      <input id="nPriceComerce" type="number" min="1" name="Price" value="{{$Product_main->pricecomerceProduct}}" class="form-control jj-number " style="border:none !important; margin-top:-5px !important" placeholder="Precio" required>
                                                                 </div>
                                                            </div>
                                                            <!---
                                        <div class="form-group pad-all">
                                                  ...
                                                  <div class="row">
                                                       <div class="col-lg-6 col-md-12">
                                                            <div class="form-group pad-all">
                                                                 ...
                                                                 <div class="input-group input-prefix number">
                                                                      <label> $ </label>
                                                                      <input id="nPricelist3" type="number" min="1" name="nPricelist3" value="{{$Product_main->price_list_3}}" class="form-control jj-number " style="border:none !important; margin-top:-5px !important" placeholder="Precio" required>
                                                                 </div>
                                                            </div>
                                                       ...
                                                       <div class="col-lg-6 col-md-12">
                                                            <div class="form-group pad-all">
                                                                 ...
                                                                 <div class="input-group input-prefix number">
                                                                      <label> $ </label>
                                                                      <input id="nPricelist4" type="number" min="1" name="nPricelist4" value="{{$Product_main->price_list_4}}" class="form-control jj-number " style="border:none !important; margin-top:-5px !important" placeholder="Precio" required>
                                                                 </div>
                                                            </div>
                                                            <!---
                                        <div class="form-group pad-all">
                                                  ...
                                                  <div class="row">
                                                       <div class="col-lg-6 col-md-12">
                                                            <div class="form-group pad-all">
                                                                 ...
                                                                 <div class="input-group input-prefix number">
                                                                      <label> $ </label>
                                                                      <input id="nPricelist5" type="number" min="1" name="nPricelist5" value="{{$Product_main->price_list_5}}" class="form-control jj-number " style="border:none !important; margin-top:-5px !important" placeholder="Precio">
                                                                 </div>
                                                            </div>
                                                       </div>
                                                       <div class="col-lg-6 col-md-12">
                                                       ...
                                                       <tbody class="store-b-manager" style="font-weight:200 !important">
                                                            ...
                                                            <tr style="color:#000">
                                                                 <td style="color:#000; font-family: arial">
                                                                      <div class="pad-all">{{$attr->nameAttribute}}</div>
                                                                 </td>
                                                                 <td style="color:#000; font-family: arial">
                                                                      <div class="pad-all">$ {{number_format($attr->priceProduct,2)}}</div>
                                                                 </td>

                                                                 <td style="color:#000; font-family: arial">
                                                                      <div class="pad-all">$ {{number_format($attr->pricecomerceProduct,2)}}</div>
                                                                 </td>

                                                                 <td style="color:#000; font-family: arial">
                                                                      <div class="pad-all">$ {{number_format($attr->price_list_3,2)}}</div>
                                                                 </td>

                                                                 <td style="color:#000; font-family: arial">
                                                                      <div class="pad-all">$ {{number_format($attr->price_list_4,2)}}</div>
                                                                 </td>

                                                                 <td style="color:#000; font-family: arial">
                                                                      <div class="pad-all">$ {{number_format($attr->price_list_5,2)}}</div>
                                                                 </td>
                                                                 ...
                                                                 <td style="color:#000; font-family: arial">
                                                                      <div class="pad-all">
                                                                           <div class="jj-button-mini">
                                                                                <div onclick="openAttrModal({{$attr->id}});">Editar </div>
                                                                           </div>
                                                                      </div>
                                                                 </td>
                                                            </tr>
