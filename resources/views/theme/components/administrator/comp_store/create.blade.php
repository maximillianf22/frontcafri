									...
									<div class="row ">
										<div class="col-lg-12">
											<div class="form-group pad-all">
												...
												<input id="titleVariation" type="text" name="titleVariation" value="" class="input-text" placeholder="nombre/titulo para la variación">
											</div>
										</div>
									</div>
										...
										<div class="col-lg-3" style="border-bottom:1px solid #DFE5EB">
											<div class="form-group pad-all">
												...
												<div class="input-group input-prefix number">
													<label> </label>
													<input id="nAmount_per_sale" type="number" min="1" name="nAmount_per_sale" value="" class="form-control jj-number " style="border:none !important; margin-top:-5px !important" placeholder=" Minimo" required>
												</div>
											</div>
										</div>
										<div class="col-lg-3" style="border-bottom:1px solid #DFE5EB">
											...
											<div class="row">
												...
												<div class="col-lg-6 col-md-12">
													<div class="form-group pad-all">
														...
														<div class="input-group input-prefix number">
															<label> $ </label>
															<input id="nPriceProduct" type="number" min="1" name="nPriceProduct" value="0" class="form-control jj-number " style="border:none !important; margin-top:-5px !important" placeholder="Precio" required>
														</div>
													</div>
												</div>
												<div class="col-lg-6 col-md-12">
													<div class="form-group pad-all">
														...
														<div class="input-group input-prefix number">
															<label> $ </label>
															<input id="nPriceComerce" type="number" min="1" name="nPriceComerce" value="" class="form-control jj-number " style="border:none !important; margin-top:-5px !important" placeholder="Precio">
														</div>
													</div>
													<!---
                                   <div class="form-group pad-all">
											...
											<div class="row">
												<div class="col-lg-6 col-md-12">
													<div class="form-group pad-all">
														...
														<div class="input-group input-prefix number">
															<label> $ </label>
															<input id="nPricelist3" type="number" min="1" name="nPricelist3" value="" class="form-control jj-number " style="border:none !important; margin-top:-5px !important" placeholder="Precio">
														</div>
													</div>
												</div>
												...
												<div class="col-lg-6 col-md-12">
													<div class="form-group pad-all">
														...
														<div class="input-group input-prefix number">
															<label> $ </label>
															<input id="nPricelist4" type="number" min="1" name="nPricelist4" value="" class="form-control jj-number " style="border:none !important; margin-top:-5px !important" placeholder="Precio">
														</div>
													</div>
													<!---
                                   <div class="form-group pad-all">
											...
											<div class="row">
												<div class="col-lg-6 col-md-12">
													<div class="form-group pad-all">
														...
														<div class="input-group input-prefix number">
															<label> $ </label>
															<input id="nPricelist5" type="number" min="1" name="nPricelist5" value="" class="form-control jj-number " style="border:none !important; margin-top:-5px !important" placeholder="Precio">
														</div>
													</div>
												</div>
												<div class="col-lg-6 col-md-12">
