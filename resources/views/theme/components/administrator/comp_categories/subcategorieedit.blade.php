...
<section class="content-wrapper">
     ...
     <div class="container-fluid pad-all">
          ...
          <form id="FrmEditProduct" action="{{route('admin.category.subcategorieupdate',$Category_->id)}}" method="post"  name="frmEditProduct" files="true" enctype="multipart/form-data">
               @csrf
                    ...
                    <div class="col-lg-10 ">
                                        ...
                                        <select name="categoriemain" class="form-control">
                                             @foreach($dataCategory as $Category)
                                                  <option value="{{ $Category->id }}" 
                                                       @if($Category->id === $Category_->idCategoriemain) selected @endif >
                         ...
                         <div class="row ">
                              <div class="col-lg-12 text-right">
                                   <button id="addNewProduct" type="submit" class="btn btn-info ">Actualizar Subcategoria</button>
                              </div>
                         </div> 
