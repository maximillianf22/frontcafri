...
<section class="content-wrapper">
     <div class="content-header-section ">
          <div class="title-section float-left">Mis Categorias</div>
          <a href="{{route('admin.category.create')}}"><div class="jj-button-new float-right">+ Nueva Categoria</div></a>
     </div>
     ...
     <div class="container-fluid pad-all">
          ...
          <table id="result" class="table table-responsive table-app-content">
            ...
            <tbody class="store-b-manager">
              ...
              <?php $ult_ = count($dataCategory); $i_ =1; ?>
               @foreach ($dataCategory as $category)
                  <tr class="showOrder" style="padding:1px">
                    ...
                    <td class="" style="padding:10px !important; text-align:center; font-size:11px">
                         <div class="jj-button-mini"><a href="{{route('admin.category.edit',$category->id)}}">Editar </a> </div>
                    </td>
                  </tr>
                @endforeach
              @else
