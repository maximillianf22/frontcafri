...
@section('title', 'Mis Subcategorias')
@section('content-theme')
<section class="content-wrapper">
     <div class="content-header-section ">
          <div class="title-section float-left">Crear Nueva Subcategoria</div>
     </div>
     ...
     <div class="container-fluid pad-all">
          ...
          <form id="FrmEditProduct" action="{{route('admin.category.subcategoriestore')}}" method="post"  name="frmEditProduct" files="true" enctype="multipart/form-data">
               @csrf
               <div class="box-body"> <div class="row">
                    <div class="col-lg-2">
                    <div class="form-group" id="idImageLinkVideo">
                         <label for="imagenCategorie" class="control-label">Imagen  </label>
                              <div class="imgEditProduct pad-all " style="min-height:150px; min-width:150px; border:1px dashed #CCC; margin: 5px 0 5px;">
                                   <img src="{{ asset('/content/upload/store/no-image-product.png') }}" alt="Imagen Subcategoria" />
                              </div>
                    ...
                    <div class="col-lg-10 ">
                         ...
                         <div class="row">
                              <div class="col-lg-6 ">
                                   <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="" class="form-control" placeholder="Nombre de la Subcategoria" required>
                                   </div>
                              </div>
                               ...
                               <div class="col-lg-3 ">
                                   <div class="form-group">
                                        ...
                                        <select name="categoriemain" class="form-control">
                                             @if(sizeof($dataCategory))
                              ...
                              <div class="col-lg-3 ">
                                   <div class="form-group">
                                        <label>Estado Subcategoria</label>
                         ...
                         <div class="row ">
                              <div class="col-lg-12 text-right">
                                   <button id="addNewProduct" type="submit" class="btn btn-info ">Crear nueva Subcategoria</button>
                              </div>
                         </div> 
