...
<section class="content-wrapper">
    ...
    <div class="content-body pad-all " style="padding:10px 10px 1px; margin:10px 20px 2px;">
        <div class="container-fluid pad-all">
            <div class="row box-content-section ">
                <div class="col-12">
                                            ...
                                            <div class="col-lg-10 ">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 ">
                                                        <div class="form-group">
                                                            <label>Perfil</label>
                                                            <select name="perfilUser" class="form-control">
                                                                @foreach($perfiles as $perfil)
                                                                    @if($perfil->id != 1 && $perfil->id != 2)
                                                                    <option value="{{$perfil->id}}" {{$dataCustomer->perfilUser == $perfil->id ? 'selected':''}}>{{$perfil->name}}</option>
                                                                    @endif
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="state" class="form-control">
                                                                <option value="1" {{$dataCustomer->idState === 1 ? 'selected': ''}}>Activo</option>
                                                                <option value="2" {{$dataCustomer->idState === 2 ? 'selected' : ''}}>Inactivo</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="row box-content-section ">
            <div class="col-12">
                <div id="filterListProduc" class=""></div>
            </div>
        </div>
    </div>
    <br /> <br />
