...
<section class="content-wrapper">
     <div class="content-header-section ">
          <div class="title-section float-left">Usuarios Sistema</div>
          <a href="{{route('admin.roles.user.create')}}"><div class="jj-button-new float-right">+ Nuevo Usuario</div></a>
     </div>
               ...
               <!-- envabezado-->
                    ...
                    <div class="head-section-component">
                         <div class="row ">
                             ...
                             <!--
                              <div class="lbl-filter" >Buscar Usuario </div>
                             ...
                             <div class="col-lg-3 col-md-12 pad-all filter-options" >
                                  <!--
                                   <div class="lbl-filter" >Estado</div>
...
-->
                             ...
                             <!--
                                   <div class="pad-all jj-button-new" onclick="filtrarCliente_();" style="border-radius:2px;">
                                        Filtrar
                                   </div>
-->
                             </div>
                ...
                @foreach ($dataUser as $customer)
                  <tr class="" style="padding:1px">
                    ...
                    <td class="" style="padding:10px !important;color:#000; text-align:left;font-weight:300; font-size:11px">
                         <div class="jj-button-mini"><a href="{{route('admin.users.edit',$customer->id)}}">Editar </a> </div>
                    </td>
                  </tr>
                @endforeach
              @else
