          ...
          <form id="FrmAccount" action="{{route('account.update',$UserAccount_->id)}}" method="post"  name="formAccount" files="true" enctype="multipart/form-data">
               ...
               <div class="row pad-all">
                    ...
                    <div class="pad-all  col-lg-5 col-md-5 col-sm-5 col-xs-12">
                         <div class="box pad" style="border:none">
                                   ...
                                   <div class="single-cards-item pad-top">
                                        ...
                                        <div class="single-product-text">
                                             @if (file_exists( public_path().'/content/upload/avatars/'.$UserAccount_->imageProfile ))
                                                  <img id="previewProfileImage" src="{{ asset('/content/upload/avatars/'.$UserAccount_->imageProfile) }}" alt="Avatar">
                                             @else
                                        ...
                                        <div class="text-center pad-no">
                                             <span class="btn btn-sm btn-file btn-primary btn-outline brd-radius">
                                                  Cambiar imagen de perfil<input type="file" accept="image/*" id="profilePicture" name="profilePicture" data-id="{{ $UserAccount_->id }}"  onchange='getFilename(this)'>
                                             </span>
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 pad-all  ">
                         <!--     
                         <div class="box">
                              <div class="box-header " style="background:none;color:#212121">
                                   <h4 class="box-title">Actualiza tu nombre de usuario o email</h4>
                              </div>
                              <div class="box-body">
                         ...
                         <div class="box" style="border:none">
                              <div class="box-body">
                                   ...
                                   @if(!empty($UserAccount_->nameBusiness))
                                   <div class="form-group has-feedback">
                                        <label class="control-label" for="username">Nombre del Negocio</label> 
                                        <div class="controls">
                                             <input type="text" value="{{ $UserAccount_->nameBusiness }}" name="name_business" class="form-control" placeholder="Nombre del Negocio" disabled>
                                        </div>
                                   </div>
                                   @endif
                                   ...
                                   <div class="form-group has-feedback">
                                        ...
                                        <div class="controls">
                                             <input type="text" value="{{ $UserAccount_->email }}" name="email" class="form-control" placeholder="Email Address" data-validation-regex-regex="([a-z0-9_\.-]+)@([\da-z\.-]+)\.([a-z\.]{2,6})" data-validation-regex-message="Ingrese un Correo Valido" disabled >
                                        </div>
