...
<head>
    ...
    <title>Inicio de sesión | {{$theme_->nameDirectory}}</title>
    <!--
    ...
    <link href="https://cdn.lineicons.com/1.0.1/LineIcons.min.css" rel="stylesheet">
     ...
     <!-- Theme style App -->
     <link href="{{asset('assets/'.$theme_->nameDirectory.'/css/master.css') }}" rel="stylesheet">
     <link href="{{asset('assets/'.$theme_->nameDirectory.'/css/styles.css') }}" rel="stylesheet">
