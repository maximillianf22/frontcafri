                         ...
                         <a href="{{route('index')}}" style="color:none !important; background:none !important">
                              @if(!empty($ConfigTheme_->logo))
                                   @if (file_exists( public_path().'/content/upload/theme/'.$ConfigTheme_->logo ))
                                        <img id="previewProfileImage" src="{{ asset('/content/upload/theme/'.$ConfigTheme_->logo) }}" alt="Avatar">
                                   @else
                                        Logo no cargado
                                   @endif
                              @else
...
de Confirmación)</div>
                              ...
                              <div class="form-group has-feedback">
                                   <div class="col-12 text-center">
                                        <button id="formRegister" type="button" class="btn  btn-bg-theme btn-block margin-top-10 " onclick="javascript:calcularEdad();" disabled style="background:#AFDBF6 !important; color:#000">Completar Registro </button>
                                   </div>
                              </div>
                         </form>
